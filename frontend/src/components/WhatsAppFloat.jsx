  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3" data-testid="whatsapp-floating">
      ...
      >
        ...
        {!open && <span className="absolute -top-1 -right-1 flex h-3 w-3"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#25D366] opacity-75"></span><span className="relative inline-flex rounded-full h-3 w-3 bg-[#3B82F6]"></span></span>}
      </motion.button>
    </div>
  );
}
