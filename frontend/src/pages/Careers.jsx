        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5 space-y-6">
            {[
              ...
              >
                <c.icon className="w-6 h-6 text-[#EA580C]" />
                <div className="font-display font-black text-lg text-[#0F172A] mt-3">{c.title}</div>
          ...
          <div className="lg:col-span-7">
            {done ? (
              <div className="glass rounded-2xl p-10 text-center" data-testid="career-success">
                ...
                <div className="font-display font-black text-2xl text-[#0F172A] mt-4">Application Received</div>
                <p className="text-[#475569] mt-2">Thanks for your interest in joining Revanth. We will reach out when a suitable role opens.</p>
                <button onClick={() => setDone(false)} className="mt-6 text-sm font-bold text-[#EA580C]" data-testid="career-new">Submit another →</button>
              </div>
            ) : (
              <form onSubmit={submit} className="glass rounded-2xl p-6 md:p-8 space-y-5" data-testid="career-form">
                <div className="text-xs uppercase tracking-[0.3em] text-[#EA580C] font-bold">Apply</div>
                <h2 className="font-display font-black text-3xl text-[#0F172A]">Tell us about yourself.</h2>
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-[#0F172A] hover:bg-[#EA580C] text-white px-8 py-4 font-bold rounded-full disabled:opacity-60 transition-colors"
                >
